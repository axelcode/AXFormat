/*
 * ==========================================================================
 * class name  : com.axelb.axformat.protocol.json.AXJsonBlock
 * 
 * Begin       : 24/04/2018
...
public class AXJsonBlock extends AXJsonValue {
	private Vector<AXJsonObject> value;
	public AXJsonBlock(Vector<AXJsonObject> value) {
		this.value = value;
		
		this.type = AXJsonValue.VALUE_OBJECT;
	}
	@Override
