/*
 * ==========================================================================
 * class name  : com.axelb.axformat.exception.AXJsonFormatException
 * 
 * Begin       : 24/04/2018
 ...
 * 
 */
package com.axelb.axformat.exception;

public abstract class AXFormatException extends Exception {
	public AXFormatException(String message) {
		super(message);
	}
}
