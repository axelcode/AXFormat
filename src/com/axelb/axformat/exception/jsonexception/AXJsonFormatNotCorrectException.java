/*
 * ==========================================================================
 * class name  : com.axelb.axformat.exception.jsonexception.AXJsonFormatNotCorrectException
 * 
 * Begin       : 24/04/2018
 ...
 * 
 */
package com.axelb.axformat.exception.jsonexception;

import com.axelb.axformat.exception.AXFormatException;

public class AXJsonFormatNotCorrectException extends AXFormatException {
	public AXJsonFormatNotCorrectException(int numberChar) {
		super("Errore alla posizione "+numberChar+": Formato JSON non valido!");
	}
}
