/*
 * ==========================================================================
 * class name  : com.axelb.axformat.exception.jsonexception.AXJsonRequestMalformedException
 * 
 * Begin       : 24/04/2018
...
public class AXJsonRequestMalformedException extends AXFormatException {
	public AXJsonRequestMalformedException(String message) {
		super(message);
	}
}
